    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Courses",
                columns: new[] { "Id", "CourseName", "CreatedAt", "Price" },
                values: new object[,]
                {
                    { 1, "Mathmatics", new DateTime(2023, 6, 30, 15, 8, 22, 476, DateTimeKind.Utc).AddTicks(2625), 1000m },
                    { 2, "Physics", new DateTime(2023, 6, 30, 15, 8, 22, 476, DateTimeKind.Utc).AddTicks(2631), 2000m },
                    { 3, "Chemistry", new DateTime(2023, 6, 30, 15, 8, 22, 476, DateTimeKind.Utc).AddTicks(2633), 1500m },
                    { 4, "Biology", new DateTime(2023, 6, 30, 15, 8, 22, 476, DateTimeKind.Utc).AddTicks(2635), 1200m },
                    { 5, "CS-50", new DateTime(2023, 6, 30, 15, 8, 22, 476, DateTimeKind.Utc).AddTicks(2636), 3000m }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 3, false, true, false, false, false, false, "Twice_A_Week", true },
